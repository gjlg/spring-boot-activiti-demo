...
@Slf4j
@Component
public class FloatActivitiDemo {
    ...
    public void deployment(){
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("processes/evection-plus.bpmn20.xml")
                .addClasspathResource("img/evection-plus.bpmn20.png")
                .name("出差申请流程非固定人")
                .deploy();
    ...
    /** 启动流程实例 */
    public void startProcess(String processDefinitionKey, Map<String, Object> map) {
